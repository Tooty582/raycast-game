...
export class Screen{
    ...
    static drawMapPixel(image, x, y, width, height, map, renderHeight, hitQueue, queueNum){
        ...
        if(y >= start && y < start + wallHeight){
            ...
            if(portal && portal.normal.equals(hitNorm)){
                ...
                if(portalColor != portal.maskColor){
                    ...
                    Screen.drawMapPixel(image, x, y, width, height, map, renderHeight, hitQueue, queueNum + 1);
                    return;
                }
            }
    ...
    static render(context, camera, map, fov, renderHeight){
        ...
        for(let x = 0; x < width; x++){
            ...
            for(let y = 0; y < height; y++){
                Screen.drawMapPixel(image, x, y, width, height, map, renderHeight, hitQueue, 0);
            }
        }
